...
import xyz.yingshaoxo.atlantisspace.AtlantisSpaceApplication;
import xyz.yingshaoxo.atlantisspace.receivers.AtlantisSpaceDeviceAdminReceiver;
import xyz.yingshaoxo.atlantisspace.services.FreezeService;
import xyz.yingshaoxo.atlantisspace.services.IAppInstallCallback;
import xyz.yingshaoxo.atlantisspace.services.IFileShuttleService;
import xyz.yingshaoxo.atlantisspace.services.IFileShuttleServiceCallback;
import xyz.yingshaoxo.atlantisspace.utilities.AuthenticationUtility;
import xyz.yingshaoxo.atlantisspace.utilities.FileProviderProxy;
import xyz.yingshaoxo.atlantisspace.utilities.InstallationProgressListener;
...
public class DummyActivity extends Activity {
    public static final String FINALIZE_PROVISION = "xyz.yingshaoxo.atlantisspace.action.FINALIZE_PROVISION";
    public static final String START_SERVICE = "xyz.yingshaoxo.atlantisspace.action.START_SERVICE";
    public static final String TRY_START_SERVICE = "xyz.yingshaoxo.atlantisspace.action.TRY_START_SERVICE";
    public static final String INSTALL_PACKAGE = "xyz.yingshaoxo.atlantisspace.action.INSTALL_PACKAGE";
    public static final String UNINSTALL_PACKAGE = "xyz.yingshaoxo.atlantisspace.action.UNINSTALL_PACKAGE";
    public static final String UNFREEZE_AND_LAUNCH = "xyz.yingshaoxo.atlantisspace.action.UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_UNFREEZE_AND_LAUNCH = "xyz.yingshaoxo.atlantisspace.action.PUBLIC_UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_FREEZE_ALL = "xyz.yingshaoxo.atlantisspace.action.PUBLIC_FREEZE_ALL";
    public static final String FREEZE_ALL_IN_LIST = "xyz.yingshaoxo.atlantisspace.action.FREEZE_ALL_IN_LIST";
    ...
    public static final String START_FILE_SHUTTLE = "xyz.yingshaoxo.atlantisspace.action.START_FILE_SHUTTLE";
    public static final String START_FILE_SHUTTLE_2 = "xyz.yingshaoxo.atlantisspace.action.START_FILE_SHUTTLE_2";
    public static final String SYNCHRONIZE_PREFERENCE = "xyz.yingshaoxo.atlantisspace.action.SYNCHRONIZE_PREFERENCE";
    public static final String PACKAGEINSTALLER_CALLBACK = "xyz.yingshaoxo.atlantisspace.action.PACKAGEINSTALLER_CALLBACK";
    ...
    private void actionStartService() {
        ...
        ((AtlantisSpaceApplication) getApplication()).bindAtlantisSpaceService(new ServiceConnection() {
            @Override
        ...
        if (getIntent().hasExtra("linkedPackages")) {
            ...
            for (int i = 0; i < packages.length; i++) {
                ...
                mPolicyManager.setApplicationHidden(
                        new ComponentName(this, AtlantisSpaceDeviceAdminReceiver.class),
                        packages[i], false);
    ...
    private void doStartFileShuttle() {
        ((AtlantisSpaceApplication) getApplication()).bindFileShuttleService(new ServiceConnection() {
            @Override
            public void onServiceConnected(ComponentName name, IBinder service) {
