...
public class AppListFragment extends BaseFragment {
    static final String BROADCAST_REFRESH = "xyz.yingshaoxo.atlantisspace.broadcast.REFRESH";
    ...
    private IAtlantisSpaceService mService = null;
    ...
    static AppListFragment newInstance(IAtlantisSpaceService service, boolean isRemote) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mService = IAtlantisSpaceService.Stub.asInterface(service);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        if (mIsRemote) {
            ...
            // TODO: If we implement God Mode (i.e. AtlantisSpace as device owner), we should
    ...
    void installAppCallback(int result, ApplicationInfoWrapper app, boolean isInstall) {
        ...
        } else if (result == AtlantisSpaceService.RESULT_CANNOT_INSTALL_SYSTEM_APP) {
            Toast.makeText(getContext(),
    ...
    void addUnfreezeShortcut(ApplicationInfoWrapper app, List<ApplicationInfoWrapper> linkedApps, Bitmap icon) {
        String id = "atlantisspace-" + app.getPackageName();
