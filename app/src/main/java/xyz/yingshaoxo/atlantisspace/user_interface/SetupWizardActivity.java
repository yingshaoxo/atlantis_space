...
public class SetupWizardActivity extends AppCompatActivity {
    ...
    // finished by the system, but the AtlantisSpace inside the profile has never been brought up
    ...
    public static final String ACTION_RESUME_SETUP = "xyz.yingshaoxo.atlantisspace.RESUME_SETUP";
    public static final String ACTION_PROFILE_PROVISIONED = "xyz.yingshaoxo.atlantisspace.PROFILE_PROVISIONED";
    ...
    private void setupProfileCb(Boolean result) {
        if (result) {
            ...
            // to click on the notification to bring up AtlantisSpace inside the
    ...
    private static class ProfileProvisionContract extends ActivityResultContract<Void, Boolean> {
        ...
        @Override
        public Intent createIntent(@NonNull Context context, Void input) {
            ComponentName admin = new ComponentName(context.getApplicationContext(), AtlantisSpaceDeviceAdminReceiver.class);
