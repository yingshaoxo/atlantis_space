...
public class MainActivity extends AppCompatActivity {
    public static final String BROADCAST_CONTEXT_MENU_CLOSED = "xyz.yingshaoxo.atlantis.broadcast.CONTEXT_MENU_CLOSED";
    public static final String BROADCAST_SEARCH_FILTER_CHANGED = "xyz.yingshaoxo.atlantis.broadcast.SEARCH_FILTER_CHANGED";
