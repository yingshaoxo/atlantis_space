...
import xyz.yingshaoxo.atlantis.services.IFileShuttleServiceCallback;
import xyz.yingshaoxo.atlantis.utilities.AuthenticationUtility;
import xyz.yingshaoxo.atlantis.utilities.FileProviderProxy;
import xyz.yingshaoxo.atlantis.utilities.InstallationProgressListener;
...
public class DummyActivity extends Activity {
    public static final String FINALIZE_PROVISION = "xyz.yingshaoxo.atlantis.action.FINALIZE_PROVISION";
    public static final String START_SERVICE = "xyz.yingshaoxo.atlantis.action.START_SERVICE";
    public static final String TRY_START_SERVICE = "xyz.yingshaoxo.atlantis.action.TRY_START_SERVICE";
    public static final String INSTALL_PACKAGE = "xyz.yingshaoxo.atlantis.action.INSTALL_PACKAGE";
    public static final String UNINSTALL_PACKAGE = "xyz.yingshaoxo.atlantis.action.UNINSTALL_PACKAGE";
    public static final String UNFREEZE_AND_LAUNCH = "xyz.yingshaoxo.atlantis.action.UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_UNFREEZE_AND_LAUNCH = "xyz.yingshaoxo.atlantis.action.PUBLIC_UNFREEZE_AND_LAUNCH";
    public static final String PUBLIC_FREEZE_ALL = "xyz.yingshaoxo.atlantis.action.PUBLIC_FREEZE_ALL";
    public static final String FREEZE_ALL_IN_LIST = "xyz.yingshaoxo.atlantis.action.FREEZE_ALL_IN_LIST";
    ...
    public static final String START_FILE_SHUTTLE = "xyz.yingshaoxo.atlantis.action.START_FILE_SHUTTLE";
    public static final String START_FILE_SHUTTLE_2 = "xyz.yingshaoxo.atlantis.action.START_FILE_SHUTTLE_2";
    public static final String SYNCHRONIZE_PREFERENCE = "xyz.yingshaoxo.atlantis.action.SYNCHRONIZE_PREFERENCE";
    public static final String PACKAGEINSTALLER_CALLBACK = "xyz.yingshaoxo.atlantis.action.PACKAGEINSTALLER_CALLBACK";
